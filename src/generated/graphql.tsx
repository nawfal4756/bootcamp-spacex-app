...
export type LaunchInfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'flight_number' | 'launch_success'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      ...
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'youtube_id' | 'wikipedia' | 'video_link'>
    )> }
  )> }
);
...
export type LaunchListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_year' | 'launch_success' | 'flight_number'>
  )>>> }
);
